...
### ------------------------------------------------ ###
#### Predictions for the best model - lmgGamm7 ####
### ---------------------------------------------- ###
...
newD1$fit <- predict(lmgGamm7, newdata = newD1, type = "link", se.fit = TRUE)[[1]]
newD1$se.fit <- predict(lmgGamm7, newdata = newD1, type = "link", se.fit = TRUE)[[2]]
newD1$tranFit <- predict(lmgGamm7, newdata = newD1, type = "response", se.fit = FALSE)

k <- visreg(lmgGamm7, "max.temp", "lmg.crash", plot = F)
plot(k, overlay = T)
...
newD2$fit <- predict(lmgGamm7, newdata = newD2, type = "link", se.fit = TRUE)[[1]]
newD2$se.fit <- predict(lmgGamm7, newdata = newD2, type = "link", se.fit = TRUE)[[2]]
newD2$tranFit <- predict(lmgGamm7, newdata = newD2, type = "response", se.fit = FALSE)
...
newD3$fit <- predict(lmgGamm7, newdata = newD3, type = "link", se.fit = TRUE)[[1]]
newD3$se.fit <- predict(lmgGamm7, newdata = newD3, type = "link", se.fit = TRUE)[[2]]
newD3$tranFit <- predict(lmgGamm7, newdata = newD3, type = "response", se.fit = FALSE)
...
newD4$fit <- predict(lmgGamm7, newdata = newD4, type = "link", se.fit = TRUE)[[1]]
newD4$se.fit <- predict(lmgGamm7, newdata = newD4, type = "link", se.fit = TRUE)[[2]]
newD4$tranFit <- predict(lmgGamm7, newdata = newD4, type = "response", se.fit = FALSE)
...
newD5 <- data.frame(max.temp = mean(data_test$max.temp),
                    ...
                    log.obs = log(3600),
                    fox.year = "Big one-2004")
newD5$fit <- predict(lmgGamm7, newdata = newD5, type = "link", se.fit = TRUE)[[1]]
newD5$se.fit <- predict(lmgGamm7, newdata = newD5, type = "link", se.fit = TRUE)[[2]]
newD5$tranFit <- predict(lmgGamm7, newdata = newD5, type = "response", se.fit = FALSE)
...
# Max.temp
comp1 <- smooth_diff(lmgGamm7, newD1, 'crash', 'noCrash', 'lmg.crash')
#x11(); par(mfrow = c(2, 2))
...
# Prec
comp2 <- smooth_diff(lmgGamm7, newD2, 'crash', 'noCrash', 'lmg.crash')
...
# DATE
comp3 <- smooth_diff(lmgGamm7, newD3, 'crash', 'noCrash', 'lmg.crash')
...
# nest.dens
comp4 <- smooth_diff(lmgGamm7, newD4, 'crash', 'noCrash', 'lmg.crash')
...
# ----- #
#l <- visreg(lmgGamm7, "prec", "lmg.crash", plot = F)
...
# --- #
#m <- visreg(lmgGamm7, "DATE", "lmg.crash", plot = F)
...
#n <- visreg(lmgGamm7, "nest.dens", "lmg.crash", plot = F)
...
for(i in re){
  ND1 <- data.frame(max.temp = v,
                    ...
                    DATE = mean(data_peak$DATE),
                    lmg.crash = "noCrash",
                    log.obs = log(3600),
                    fox.year = i)
  
  ND1$tranFit <- predict(lmgGamm7, newdata = ND1, type = "response", se.fit = FALSE)
...
for(i in re){
  ...
  ND2$tranFit <- predict(lmgGamm7, newdata = ND2, type = "response", se.fit = FALSE)
...
# png("C:/Users/HP_9470m/Dropbox/PHD. Claire/Chapitres de thèse/CHAPTER 3 - Fox predation & climate variables/FOX PRED PAPER/Figures paper/FOX_PAPER_Ann_Random_eff_date.tiff",
#     res=300,
#     width=30,
#     height= 20,
#     pointsize=12,
...
for(i in re){
  ...
  ND3$tranFit <- predict(lmgGamm7, newdata = ND3, type = "response", se.fit = FALSE)
...
for(i in re){
  ND5 <- data.frame(max.temp = mean(data_test$max.temp),
                    ...
                    ND5$tranFit <- predict(lmgGamm7, newdata = ND5, type = "response", se.fit = FALSE)
